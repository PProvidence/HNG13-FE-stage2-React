...
const TicketCard: FC<TicketCardProps> = ({ ticket, onEdit, onDelete }) => (
  <article className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all p-6 animate-fade-slide-in">
    <div className="flex justify-between items-start mb-4">
      <span
        className={`px-4 py-1 rounded-full text-xs font-semibold text-white bg-linear-to-r ${statusColors[ticket.status]}`}
      >
